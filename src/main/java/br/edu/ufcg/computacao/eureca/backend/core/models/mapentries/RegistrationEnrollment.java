...
public class RegistrationEnrollment extends EurecaMapKey {
    String registration;
    int enrollment_id;

    public RegistrationEnrollment(String registration, int enrollment_id) {
        this.registration = registration;
        this.enrollment_id = enrollment_id;
    }

    public RegistrationEnrollment() {}
    ...
    public boolean equals(Object obj) {
        ...
        RegistrationEnrollment other = (RegistrationEnrollment) obj;
